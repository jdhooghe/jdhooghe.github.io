...
BLOG_AUTHOR = "Justin Dhooghe"  # (translatable)
BLOG_TITLE = "Excursion in Data Science"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://jdhooghe.github.io/"
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ...
        ("/categories/Regression.html", "Regression"),
    ),
}
